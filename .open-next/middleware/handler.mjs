      ...
      t.m = e, t.amdO = {}, (() => {
        ...
        t.O = (r2, o, n, i) => {
          ...
          for (var l = 1 / 0, a = 0; a < e2.length; a++) {
            for (var [o, n, i] = e2[a], f = true, u = 0; u < o.length; u++) (false & i || l >= i) && Object.keys(t.O).every((e3) => t.O[e3](o[u])) ? o.splice(u--, 1) : (f = false, i < l && (l = i));
            if (f) {
              e2.splice(a--, 1);
              var p = n();
              void 0 !== p && (r2 = p);
        ...
        var r2 = new URL(e2, "x:/"), t2 = {};
        for (var o in r2) t2[o] = r2[o];
        for (var o in t2.href = e2, t2.pathname = e2.replace(/[?#].*/, ""), t2.origin = t2.protocol = "", t2.toString = t2.toJSON = () => e2, t2) Object.defineProperty(this, o, { enumerable: true, configurable: true, value: t2[o] });
      }, t.U.prototype = URL.prototype, (() => {
        var e2 = { 149: 0 };
        t.O.j = (r3) => 0 === e2[r3];
        var r2 = (r3, o2) => {
          var n, i, [a, l, f] = o2, u = 0;
          if (a.some((r4) => 0 !== e2[r4])) {
            for (n in l) t.o(l, n) && (t.m[n] = l[n]);
            if (f) var p = f(t);
          }
          for (r3 && r3(o2); u < a.length; u++) i = a[u], t.o(e2, i) && e2[i] && e2[i][0](), e2[i] = 0;
          return t.O(p);
...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 1552: (e, t, r) => {
      "use strict";
      var n = r(5356).Buffer;
      ...
      (() => {
        var i = { 226: function(i2, a2) {
          !function(o2, s) {
            "use strict";
            var l = "function", u = "undefined", c = "object", d = "string", p = "major", h = "model", g = "name", f = "type", b = "vendor", v = "version", m = "architecture", _ = "console", w = "mobile", y = "tablet", x = "smarttv", E = "wearable", S = "embedded", O = "Amazon", R = "Apple", C = "ASUS", P = "BlackBerry", T = "Browser", N = "Chrome", I = "Firefox", M = "Google", k = "Huawei", A = "Microsoft", j = "Motorola", L = "Opera", D = "Samsung", q = "Sharp", U = "Sony", B = "Xiaomi", V = "Zebra", z = "Facebook", $ = "Chromium OS", G = "Mac OS", H = function(e2, t2) {
              var r2 = {};
              ...
              return this.getBrowser = function() {
                ...
                var e3 = {};
                return e3[g] = s, e3[v] = s, Q.call(e3, n2, a3.os), _2 && !e3[g] && i3 && "Unknown" != i3.platform && (e3[g] = i3.platform.replace(/chrome os/i, $).replace(/macos/i, G)), e3;
  ...
  `);
      ...
      class $ extends Response {
            ...
            switch (n3) {
              ...
              case "set":
                return (...i3) => {
                  ...
                  return a2 instanceof L.ResponseCookies && r2.set("x-middleware-set-cookie", a2.getAll().map((e12) => (0, L.stringifyCookie)(e12)).join(",")), z(t2, o2), a2;
                };
              default:
        ...
        static redirect(e10, t2) {
          ...
          return i2.set("Location", _(e10)), new $(null, { ...n2, headers: i2, status: r2 });
        }
        static rewrite(e10, t2) {
          let r2 = new Headers(null == t2 ? void 0 : t2.headers);
          return r2.set("x-middleware-rewrite", _(e10)), z(t2, r2), new $(null, { ...t2, headers: r2 });
        }
        static next(e10) {
          let t2 = new Headers(null == e10 ? void 0 : e10.headers);
          return t2.set("x-middleware-next", "1"), z(e10, t2), new $(null, { ...e10, headers: t2 });
        }
      }
      function G(e10, t2) {
      ...
      class eI {
        ...
        trace(...e10) {
          ...
          if (!ef.includes(r2) && "1" !== process.env.NEXT_OTEL_VERBOSE || o2.hideSpan) return a2();
          ...
          return o2.attributes = { "next.span_name": s2, "next.span_type": r2, ...o2.attributes }, em.with(l2.setValue(eC, c2), () => this.getTracerInstance().startActiveSpan(s2, o2, (e11) => {
            ...
            try {
              if (a2.length > 1) return a2(e11, (t5) => eO(e11, t5));
              let t4 = a2(e11);
      ...
      let eB = Symbol.for("@next/cache-handlers-map"), eV = Symbol.for("@next/cache-handlers-set"), ez = globalThis;
      function e$() {
      ...
      let eQ = "undefined" != typeof globalThis && globalThis.AsyncLocalStorage, eY = eQ ? new eQ() : new eK();
      class eZ {
        ...
        after(e10) {
          if (ev(e10)) this.waitUntil || eJ(), this.waitUntil(e10.catch((e11) => this.reportTaskError("promise", e11)));
          ...
          if ("/middleware" === e10.page || "/src/middleware" === e10.page) {
            ...
            return eM().trace(eg.execute, { spanName: `middleware ${h2.method} ${h2.nextUrl.pathname}`, attributes: { "http.target": h2.nextUrl.pathname, "http.method": h2.method } }, async () => {
              try {
                ...
                return await Q.I.run(b3, () => Y.e.run(g3, e10.handler, h2, f2));
              } finally {
                setTimeout(() => {
                  r2.dispatchClose();
                }, 0);
      ...
      function ti(e10) {
        if (e10.nextUrl.pathname.startsWith("/v1/")) {
          let t2 = e10.headers.get("Authorization") || e10.headers.get("x-api-key"), r2 = process.env.V1_API_KEY;
          if (!r2) return $.next();
          if (!t2 || t2 !== `Bearer ${r2}` && t2 !== r2) return new $(JSON.stringify({ error: "Unauthorized. Provide x-api-key or Authorization: Bearer <key>" }), { status: 401, headers: { "Content-Type": "application/json" } });
        }
        return $.next();
      }
      RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), /* @__PURE__ */ new WeakMap();
      let ta = { matcher: ["/v1/:path*"] }, to = (Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 }), { ...i }), ts = to.middleware || to.default, tl = "/middleware";
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/v1(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.js", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": true }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/Users/admin.cesar.a.nogueira/Desktop/ishormuzopen-nextjs", "experimental": { "nodeMiddleware": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 0, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 13, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedRoutes": false, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "useEarlyImport": false, "viewTransition": false, "routerBFCache": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "dynamicIO": false, "inlineCss": false, "useCache": false, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-squlite-node", "@effect/sql-squlite-bun", "@effect/sql-squlite-wasm", "@effect/sql-squlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "Mediapartners-Google|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti", "bundlePagesRouterDependencies": false, "configFileName": "next.config.js", "serverExternalPackages": ["ws"], "turbopack": { "root": "/Users/admin.cesar.a.nogueira/Desktop/ishormuzopen-nextjs" } };
var BuildId = "_DripwgCLnPHxaSeQSthg";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/embed", "regex": "^/embed(?:/)?$", "routeKeys": {}, "namedRegex": "^/embed(?:/)?$" }, { "page": "/feed.xml", "regex": "^/feed\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/feed\\.xml(?:/)?$" }, { "page": "/methodology", "regex": "^/methodology(?:/)?$", "routeKeys": {}, "namedRegex": "^/methodology(?:/)?$" }, { "page": "/robots.txt", "regex": "^/robots\\.txt(?:/)?$", "routeKeys": {}, "namedRegex": "^/robots\\.txt(?:/)?$" }, { "page": "/sitemap.xml", "regex": "^/sitemap\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/sitemap\\.xml(?:/)?$" }, { "page": "/v1/events", "regex": "^/v1/events(?:/)?$", "routeKeys": {}, "namedRegex": "^/v1/events(?:/)?$" }, { "page": "/v1/metrics", "regex": "^/v1/metrics(?:/)?$", "routeKeys": {}, "namedRegex": "^/v1/metrics(?:/)?$" }, { "page": "/v1/status", "regex": "^/v1/status(?:/)?$", "routeKeys": {}, "namedRegex": "^/v1/status(?:/)?$" }], "dynamic": [], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/robots.txt": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "text/plain", "x-next-cache-tags": "_N_T_/layout,_N_T_/robots.txt/layout,_N_T_/robots.txt/route,_N_T_/robots.txt" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/robots.txt", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/sitemap.xml": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "application/xml", "x-next-cache-tags": "_N_T_/layout,_N_T_/sitemap.xml/layout,_N_T_/sitemap.xml/route,_N_T_/sitemap.xml" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/sitemap.xml", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/methodology": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/methodology", "dataRoute": "/methodology.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/embed": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/embed", "dataRoute": "/embed.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "14bfd132f938504279f9c739a2139201", "previewModeSigningKey": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d", "previewModeEncryptionKey": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/v1(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/v1/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } } }, "functions": { "/api/confirm/route": { "files": ["server/server-reference-manifest.js", "server/app/api/confirm/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/confirm/route.js"], "name": "app/api/confirm/route", "page": "/api/confirm/route", "matchers": [{ "regexp": "^/api/confirm$", "originalSource": "/api/confirm" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/alert-check/route": { "files": ["server/server-reference-manifest.js", "server/app/api/alert-check/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/edge-chunks/45.js", "server/app/api/alert-check/route.js"], "name": "app/api/alert-check/route", "page": "/api/alert-check/route", "matchers": [{ "regexp": "^/api/alert\\-check$", "originalSource": "/api/alert-check" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/health/route": { "files": ["server/server-reference-manifest.js", "server/app/api/health/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/health/route.js"], "name": "app/api/health/route", "page": "/api/health/route", "matchers": [{ "regexp": "^/api/health$", "originalSource": "/api/health" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/og/route": { "files": ["server/server-reference-manifest.js", "server/app/api/og/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/app/api/og/route.js"], "name": "app/api/og/route", "page": "/api/og/route", "matchers": [{ "regexp": "^/api/og$", "originalSource": "/api/og" }], "wasm": [{ "name": "wasm_77d9faebf7af9e421806970ce10a58e9d83116d7", "filePath": "server/edge-chunks/wasm_77d9faebf7af9e421806970ce10a58e9d83116d7.wasm" }, { "name": "wasm_ef4866ecae192fd87727067cf2c0c0cf9fb8b020", "filePath": "server/edge-chunks/wasm_ef4866ecae192fd87727067cf2c0c0cf9fb8b020.wasm" }], "assets": [{ "name": "noto-sans-v27-latin-regular.5dda3fca77107598.ttf", "filePath": "server/edge-chunks/asset_noto-sans-v27-latin-regular.5dda3fca77107598.ttf" }], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/subscribe/route": { "files": ["server/server-reference-manifest.js", "server/app/api/subscribe/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/edge-chunks/45.js", "server/app/api/subscribe/route.js"], "name": "app/api/subscribe/route", "page": "/api/subscribe/route", "matchers": [{ "regexp": "^/api/subscribe$", "originalSource": "/api/subscribe" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/brent/route": { "files": ["server/server-reference-manifest.js", "server/app/api/brent/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/brent/route.js"], "name": "app/api/brent/route", "page": "/api/brent/route", "matchers": [{ "regexp": "^/api/brent$", "originalSource": "/api/brent" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/markets/route": { "files": ["server/server-reference-manifest.js", "server/app/api/markets/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/markets/route.js"], "name": "app/api/markets/route", "page": "/api/markets/route", "matchers": [{ "regexp": "^/api/markets$", "originalSource": "/api/markets" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/unsubscribe/route": { "files": ["server/server-reference-manifest.js", "server/app/api/unsubscribe/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/unsubscribe/route.js"], "name": "app/api/unsubscribe/route", "page": "/api/unsubscribe/route", "matchers": [{ "regexp": "^/api/unsubscribe$", "originalSource": "/api/unsubscribe" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/news/route": { "files": ["server/server-reference-manifest.js", "server/app/api/news/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/news/route.js"], "name": "app/api/news/route", "page": "/api/news/route", "matchers": [{ "regexp": "^/api/news$", "originalSource": "/api/news" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/weather/route": { "files": ["server/server-reference-manifest.js", "server/app/api/weather/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/weather/route.js"], "name": "app/api/weather/route", "page": "/api/weather/route", "matchers": [{ "regexp": "^/api/weather$", "originalSource": "/api/weather" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/vessels/route": { "files": ["server/server-reference-manifest.js", "server/app/api/vessels/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/vessels/route.js"], "name": "app/api/vessels/route", "page": "/api/vessels/route", "matchers": [{ "regexp": "^/api/vessels$", "originalSource": "/api/vessels" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/feed.xml/route": { "files": ["server/server-reference-manifest.js", "server/app/feed.xml/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/feed.xml/route.js"], "name": "app/feed.xml/route", "page": "/feed.xml/route", "matchers": [{ "regexp": "^/feed\\.xml$", "originalSource": "/feed.xml" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/v1/events/route": { "files": ["server/server-reference-manifest.js", "server/app/v1/events/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/v1/events/route.js"], "name": "app/v1/events/route", "page": "/v1/events/route", "matchers": [{ "regexp": "^/v1/events$", "originalSource": "/v1/events" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/api/timeline/route": { "files": ["server/server-reference-manifest.js", "server/app/api/timeline/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/api/timeline/route.js"], "name": "app/api/timeline/route", "page": "/api/timeline/route", "matchers": [{ "regexp": "^/api/timeline$", "originalSource": "/api/timeline" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/v1/metrics/route": { "files": ["server/server-reference-manifest.js", "server/app/v1/metrics/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/v1/metrics/route.js"], "name": "app/v1/metrics/route", "page": "/v1/metrics/route", "matchers": [{ "regexp": "^/v1/metrics$", "originalSource": "/v1/metrics" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } }, "/v1/status/route": { "files": ["server/server-reference-manifest.js", "server/app/v1/status/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/130.js", "server/edge-chunks/79.js", "server/app/v1/status/route.js"], "name": "app/v1/status/route", "page": "/v1/status/route", "matchers": [{ "regexp": "^/v1/status$", "originalSource": "/v1/status" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "_DripwgCLnPHxaSeQSthg", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "hnRB5C/laQojTi9pUt5+2uKrbHk1Xbd7vmmJRLz5mME=", "__NEXT_PREVIEW_MODE_ID": "14bfd132f938504279f9c739a2139201", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "aee40e3de2e4f0e6cb49621dc0bb79be07fbe8850301a004363ab6b0d1a9011c", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "f4d42b6cb7f079d38272e6c1a8e7a6f7ad22cd7b12f94d2171f689a8aeffee1d" } } }, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/robots.txt/route": "/robots.txt", "/sitemap.xml/route": "/sitemap.xml", "/page": "/", "/methodology/page": "/methodology", "/embed/page": "/embed", "/api/confirm/route": "/api/confirm", "/api/alert-check/route": "/api/alert-check", "/api/health/route": "/api/health", "/api/og/route": "/api/og", "/api/subscribe/route": "/api/subscribe", "/api/brent/route": "/api/brent", "/api/markets/route": "/api/markets", "/api/unsubscribe/route": "/api/unsubscribe", "/api/news/route": "/api/news", "/api/weather/route": "/api/weather", "/api/vessels/route": "/api/vessels", "/feed.xml/route": "/feed.xml", "/v1/events/route": "/v1/events", "/api/timeline/route": "/api/timeline", "/v1/metrics/route": "/v1/metrics", "/v1/status/route": "/v1/status" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/confirm": {}, "/api/health": {}, "/api/alert-check": {}, "/api/og": {}, "/api/brent": {}, "/api/markets": {}, "/api/subscribe": {}, "/api/news": {}, "/api/unsubscribe": {}, "/feed.xml": {}, "/api/timeline": {}, "/v1/events": {}, "/api/vessels": {}, "/v1/metrics": {}, "/api/weather": {}, "/v1/status": {} } };
